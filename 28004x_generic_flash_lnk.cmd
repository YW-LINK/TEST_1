...
//   RAMLS4      		: origin = 0x00A000, length = 0x000800
   ...
   FLASH_BANK0_SEC2  : origin = 0x083000, length = 0x00D000	/* on-chip Flash */
...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMLS5      : origin = 0x00A800, length = 0x001400
//   RAMLS6      : origin = 0x00B800, length = 0x000400
//   RAMLS6      : origin = 0x00B000, length = 0x000800
//   RAMLS7      : origin = 0x00B800, length = 0x000800

   RAMGS0      : origin = 0x00C000, length = 0x002000
   RAMGS1      : origin = 0x00E000, length = 0x005FF8
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC2 ,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK0_SEC1,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK0_SEC1,     PAGE = 0, ALIGN(4)
   .reset           : > RESET,     PAGE = 0, TYPE = DSECT /* not used, */

   .stack           : > RAMM1,     PAGE = 1
   .freertosStaticStack  : >> RAMGS0
   .freertosHeap         : >  RAMGS0
   .fifotxtext           : >> RAMGS0
   .logport           : >> RAMGS1
   .temport           : >> RAMGS1
